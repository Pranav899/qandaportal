	   					...
	   					<div class = "display-question">
	   						...
	   						<div class = "question-inside" id = "question_keywords">
									Topics :
	   								...
	   								<span id = "duplicate-entry-form">Mark as Duplicate</span>
	   						</div>
	   						
	   						<div class = "question-inside" id = "duplicate-form">
	   							<form method = "POST" action = "/qandaportal/rest/question/${question.questionId}/parent" id = "submit-parent-id-form">
	   								<span>Enter the original question Id : </span>
	   								<input type = "number" id = "original-question-id" name = "parentId">
	   								<input type = "submit" id = "submit-original-id">
	   							</form>
	   						</div>
	   				  </div>
							...
							<div class = "display-answer" id = "display-answer">
	   						...
	   						<div class = "answer-content">
	   							...
	   							<div class = "answer-data">
	   									<div class = "answer-comments" id = "answe-comments"><a href = "/qandaportal/rest/comments/${question.questionId}/${answer.answerId}">Comments</a></div>
